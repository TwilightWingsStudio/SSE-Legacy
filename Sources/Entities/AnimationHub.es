...
properties:
 ...
 10 CEntityPointer m_penTarget0  "Target 01" 'T' COLOR(C_GREEN|0xFF),
 11 CEntityPointer m_penTarget1  "Target 02" 'Y' COLOR(C_GREEN|0xFF),
 12 CEntityPointer m_penTarget2  "Target 03" 'U' COLOR(C_GREEN|0xFF),
 13 CEntityPointer m_penTarget3  "Target 04" 'I' COLOR(C_GREEN|0xFF),
 14 CEntityPointer m_penTarget4  "Target 05" 'O' COLOR(C_GREEN|0xFF),
 15 CEntityPointer m_penTarget5  "Target 06"     COLOR(C_GREEN|0xFF),
 16 CEntityPointer m_penTarget6  "Target 07"     COLOR(C_GREEN|0xFF),
 17 CEntityPointer m_penTarget7  "Target 08"     COLOR(C_GREEN|0xFF),
 18 CEntityPointer m_penTarget8  "Target 09"     COLOR(C_GREEN|0xFF),
 19 CEntityPointer m_penTarget9  "Target 10"     COLOR(C_GREEN|0xFF),

 20 FLOAT m_tmDelay0 "Delay 01" = 0.0f,
 21 FLOAT m_tmDelay1 "Delay 02" = 0.0f,
 22 FLOAT m_tmDelay2 "Delay 03" = 0.0f,
 23 FLOAT m_tmDelay3 "Delay 04" = 0.0f,
 24 FLOAT m_tmDelay4 "Delay 05" = 0.0f,
 25 FLOAT m_tmDelay5 "Delay 06" = 0.0f,
 26 FLOAT m_tmDelay6 "Delay 07" = 0.0f,
 27 FLOAT m_tmDelay7 "Delay 08" = 0.0f,
 28 FLOAT m_tmDelay8 "Delay 09" = 0.0f,
 29 FLOAT m_tmDelay9 "Delay 10" = 0.0f,
