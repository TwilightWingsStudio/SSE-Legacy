...
void CInGameMenu::Initialize_t(void)
{
  ...
  gm_lhChildren.AddTail(gm_mgLabel1.mg_lnNode);
  ...
  gm_lhChildren.AddTail(gm_mgLabel2.mg_lnNode);
  ...
  gm_lhChildren.AddTail(gm_mgQuickSave.mg_lnNode);
  ...
  gm_lhChildren.AddTail(gm_mgSave.mg_lnNode);
  ...
  gm_lhChildren.AddTail(gm_mgDemoRec.mg_lnNode);
  ...
  gm_lhChildren.AddTail(gm_mgStop.mg_lnNode);
