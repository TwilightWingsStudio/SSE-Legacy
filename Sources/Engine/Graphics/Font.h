...
class ENGINE_API CFontData : public CSerial
{
  ...
  public:
    ...
    inline void SetVariableWidth(void) { fd_bFixedWidth = fd_bMonotype; };
    ...
    void Read_EFND_t(CTStream *inFile); // throw char *
    void Read_FTTF_t(CTStream *inFile); // throw char *

    void Write_t( CTStream *outFile); // throw char *
    void Write_EFND_t(CTStream *outFile); // throw char *
